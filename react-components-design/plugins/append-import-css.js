/*
 * @Author: wangDong Xu
 * @Date: 2022-01-16 08:42:54
 * @LastEditors: wangDong Xu
 * @LastEditTime: 2022-01-16 08:42:55
 * @Description: file content
 * @FilePath: /react-component-library/react-components-design/plugins/append-import-css.js
    ...
    generateBundle(_, bundle) {
      ...
      for (const [key, file] of files) {
        ...
        magicString.appendLeft(
          0,
          `import './${cssFileName}';${process.env.NODE_ENV === 'development' ? '\n' : ''
          }`
        );
